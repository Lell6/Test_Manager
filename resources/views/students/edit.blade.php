<x-app-layout>
    ...
    <div class="flex min-h-0 min-w-0 gap-5 my-5 p-5 bg-gray-400 rounded w-1/3 justify-center">
        <form method="POST" action="{{ route('student.update', ['student' => $student->id]) }}" class="w-full">
            @csrf
            @method('patch')
            ...
            <div class="mt-4">
                ...
                <x-text-input id="surname" class="block mt-1 w-full" type="text" name="surname" :value="old('surname', $student->surname)" required autofocus autocomplete="surname" />
