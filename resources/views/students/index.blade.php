<x-app-layout>
    <x-slot name="header">
        <div class="flex flex-row gap-2 items-center">
            <a href="{{ route('student.create') }}" class="material-icons text-white hover:bg-green-600 rounded p-1 border-r border-white">add</a>
    ...
    <div class="flex flex-col justify-center min-h-0 min-w-0 gap-1 my-5 p-4 bg-gray-400 rounded w-full">
        ...
        <table id="dataTable" class="hidden text-sm text-left text-gray-500 bg-gray-600 dark:text-gray-400 shadow-md">
